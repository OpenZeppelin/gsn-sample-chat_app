  ...
  render() {
    return (
      <div className={styles.button}>
        <Tooltip message="Sign your transaction inside MetaMask in the traditional way." placement="top">
        <Button size="small" onClick={() => this.setProvider("MetaMask")}>
          MetaMask
        </Button></Tooltip>
        <Tooltip message="Use MetaMask to sign a message for the GSN Relay but not to sign a transaction." placement="top">
        <Button size="small" onClick={() => this.setProvider("MMSigner")}>
          MM Signer
        </Button></Tooltip>
        <Tooltip message="Use a keypair, generated in the browser, to sign a message for the GSN Relay. No MetaMask involved!" placement="top">
